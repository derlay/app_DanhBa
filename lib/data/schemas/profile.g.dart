...
int _profileEstimateSize(
  ...
  {
    final value = object.avatarBase64;
    if (value != null) {
...
Profile _profileDeserialize(
  ...
  final object = Profile(
    avatarBase64: reader.readStringOrNull(offsets[0]),
...
extension ProfileQueryFilter
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64IsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64EqualTo(
    String? value, {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64GreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64LessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64Between(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64StartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64EndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64Contains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64Matches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> avatarBase64IsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'avatarBase64',
        value: '',
...
extension ProfileQuerySortBy on QueryBuilder<Profile, Profile, QSortBy> {
  QueryBuilder<Profile, Profile, QAfterSortBy> sortByAvatarBase64() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarBase64', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> sortByAvatarBase64Desc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarBase64', Sort.desc);
    });
  }
...
extension ProfileQuerySortThenBy
  ...
  QueryBuilder<Profile, Profile, QAfterSortBy> thenByAvatarBase64() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarBase64', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> thenByAvatarBase64Desc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarBase64', Sort.desc);
    });
  }
...
extension ProfileQueryWhereDistinct
  ...
  QueryBuilder<Profile, Profile, QDistinct> distinctByAvatarBase64(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'avatarBase64', caseSensitive: caseSensitive);
    });
  }
...
extension ProfileQueryProperty
  ...
  QueryBuilder<Profile, String?, QQueryOperations> avatarBase64Property() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'avatarBase64');
    });
  }
